...
const DocumentManagementSystem = () => {
  ...
  const styles = {
    ...
    header: {
      ...
      color: 'white',
      borderRadius: '16px',//ความนขอบมนของมุมส่วนหัว
    ...
    filterContainer: {
      display: 'flex',
      gap: '16px',//ระยะห่างระหว่าง select
      alignItems: 'center',
      flexWrap: 'wrap'
    },
    filterLabel: {
    ...
    select: {
      padding: '8px 12px',//ขนาดของ select
      border: '1px solid #e5e7eb',
      borderRadius: '8px',
      fontSize: '14px',//ขนาดของตัวอักษรใน select
      outline: 'none',
      cursor: 'pointer',
      backgroundColor: 'white'
    },
    statsGrid: {
      ...
      gap: '24px',//ระยะห่างระหว่างการ์ดสถิติ
      marginBottom: '32px'
    },
    statCard: {
      padding: '20px',//ขนาดของการ์ดสถิติ
      borderRadius: '12px',//ขอบมนของการ์ดสถิติ
      color: 'white',
      boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)',
      textAlign: 'center'
    },
    ...
    documentsGrid: {
      display: 'grid',
      gridTemplateColumns: 'repeat(auto-fit, minmax(1000px, 1fr))',//ขนาดของการ์ดเอกสาร
      gap: '24px'//ขนาดของระยะห่างระหว่างการ์ดเอกสาร
    },
    documentCard: {
      backgroundColor: 'white',
      borderRadius: '12px',//คงามนของมุมการ์ดเอกสาร
    ...
    categoryTag: {
      padding: '4px 8px',//ขนาดของแท็กหมวดหมู่
      background: 'linear-gradient(135deg, #7c3aed 0%, #3b82f6 100%)',
      color: 'white',
      fontSize: '12px',
      borderRadius: '12px'
      ...
      <div style={styles.wrapper}>
        ...
        <div style={styles.searchSection}>
          <div style={styles.searchContainer}>
            ...
            >
              <Search style={{width: '20px', height: '20px'}} />//ปุ่มค้นหา
              ค้นหา
            </button>
          </div>
